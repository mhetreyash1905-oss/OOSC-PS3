  ...
  const rightsList: RightItem[] = [
    {
      ...
      summary: 'E-commerce platforms (e.g. Flipkart, Amazon) and sellers cannot refuse refund or replacement for defective products or misleading services.',
      enforcement: 'Lodge grievance on National Consumer Helpline (1915). File petition at District Consumer Disputes Redressal Commission.'
    },
    {
      id: 'r2',
    ...
    <div className="min-h-screen bg-[#fbfcf9] dark:bg-[#121111] text-gray-900 dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0e6670]/10 dark:bg-[#e7b85b]/10 text-[#0e6670] dark:text-[#e7b85b] text-xs font-extrabold border border-[#0e6670]/20 dark:border-[#e7b85b]/30">
            <span>⚖️</span>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        <div className="space-y-4">
          <div className="relative max-w-2xl mx-auto">
            <input
              ...
              placeholder="Search by keyword, section, or act (e.g. 'deposit', 'Section 6(1)', 'flipkart')..."
              className="w-full px-6 py-4 rounded-2xl border border-gray-200 dark:border-[#333] bg-white dark:bg-[#1d1b1b] text-gray-900 dark:text-white text-sm outline-none focus:ring-2 focus:ring-[#0e6670] shadow-md transition-all"
            />
            {searchTerm && (
              <button
          ...
          {filteredRights.length === 0 ? (
            ...
            filteredRights.map((right) => (
              ...
              >
                ...
                <div className="p-4 bg-gray-50 dark:bg-[#252323] rounded-2xl border border-gray-100 dark:border-[#363333] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-700 dark:text-gray-300 mt-0.5 font-medium">{right.enforcement}</p>
                  </div>
                  <Link
                    href="/application-generator"
                    className="shrink-0 inline-flex items-center gap-1 text-xs font-extrabold text-[#0e6670] dark:text-[#e7b85b] hover:underline"
                  >
