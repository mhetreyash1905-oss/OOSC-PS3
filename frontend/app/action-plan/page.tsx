...
export default function ActionPlanPage() {
  ...
  const topicPresets: Record<string, { name: string; icon: string; description: string; steps: ActionStep[] }> = {
    ...
    consumer: {
      ...
      icon: '🛍️',
      description: 'Action plan for defective online orders, platform refund refusals, and e-commerce disputes.',
      steps: [
    ...
    <div className="min-h-screen bg-[#fbfcf9] dark:bg-[#121111] text-gray-900 dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 dark:border-[#333] pb-6">
          ...
          <Link
            href="/platform"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#0e6670] to-[#124b55] hover:from-[#094d54] hover:to-[#0e3b43] text-white font-extrabold text-xs sm:text-sm px-5 py-3 rounded-xl shadow-md hover:shadow-lg transition-all"
          >
        ...
        <div className="bg-white dark:bg-[#1d1b1b] rounded-3xl p-6 sm:p-8 border border-gray-200 dark:border-[#333] shadow-md flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex-1 w-full space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-gray-400">Roadmap Completion</span>
        ...
        <div className="bg-gradient-to-r from-[#0b2b31] via-[#0e6670] to-[#124b55] rounded-3xl p-8 text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
            <h3 className="text-xl font-extrabold mb-1">Ready to generate formal applications for this plan?</h3>
            <p className="text-xs sm:text-sm text-[#d4eae6] font-medium">
          ...
          <Link
            ...
            className="shrink-0 bg-gradient-to-r from-[#e7b85b] to-[#f3ca76] hover:from-[#f3ca76] hover:to-[#e7b85b] text-[#102a2e] font-extrabold text-xs sm:text-sm px-6 py-3.5 rounded-2xl shadow-lg transition-all"
          >
